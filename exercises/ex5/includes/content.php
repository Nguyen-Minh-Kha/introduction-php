...
<ul>
    <li>Likes :<?php echo($tab['likes']) ?></li>
    <li>Difficulte :<?php echo($tab['difficulte']) ?></li>
    <li>prix :<?php echo($tab['prix']) ?></li>
    <li>active :
        <?php
        if ($tab['active']) {
            echo ("oui");
...
<p> Auteur : <?php echo($tab['auteur']['nom'] . " " . $tab['auteur']['prenom']) ?> </p> -->
